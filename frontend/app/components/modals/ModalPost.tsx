...
const Modal: React.FC<ModalProps> = ({ message, onClose }) => {
  ...
  const handleViewHistory = () => {
    onClose();
    router.push('/riwayat'); // Adjust this path to match your history route
  };

  // Check if this is a success message (consultation created successfully)
      ...
      <div className="bg-white rounded-2xl p-8 mx-4 max-w-md w-full shadow-2xl transform animate-scaleIn">
        <div className="text-center">
          ...
          <h3 className={`text-xl font-bold mb-4 ${
            ...
            {isSuccessMessage ? 'Konsultasi Berhasil!' : 'Informasi'}
          </h3>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <p className="text-sm text-blue-700">
                    <strong>Tips:</strong> Anda dapat melihat status dan detail konsultasi yang baru dibuat di halaman <strong>Riwayat Konsultasi</strong>.
                  </p>
                </div>
              </div>
            </div>
