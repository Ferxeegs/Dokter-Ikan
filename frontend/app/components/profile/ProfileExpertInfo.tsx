...
export default function ProfileExpertInfo({ fishExpert }: ProfileExpertInfoProps) {
  return (
    <div className="space-y-6 mt-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="relative">
          <label className="block text-gray-900 font-semibold mb-2">Spesialisasi</label>
          <div className="flex items-center">
            <span className="absolute left-3 text-gray-500">
              <Award size={18} />
            </span>
            <input 
              type="text" 
              value={fishExpert.specialization} 
              className="w-full p-3 pl-10 text-gray-900 border rounded-lg bg-white/60 backdrop-blur-md shadow-sm" 
              disabled 
            />
          </div>
        ...
        <div className="relative">
          <label className="block text-gray-900 font-semibold mb-2">Pengalaman</label>
          <div className="flex items-center">
            <span className="absolute left-3 text-gray-500">
              <Briefcase size={18} />
            </span>
